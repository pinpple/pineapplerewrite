...
local Library do 
    ...
    Library = {
        ...
        Folders = {
            Directory = "pineapple",
            Configs = "pineapple/configs",
            Assets = "pineapple/assets",
        },
    ...
    local CustomFont = { } do
        function CustomFont:New(Name, Weight, Style, Data)
            if not isfile(`{Library.Folders.Assets}/{Data.Id}`) then 
                writefile(`{Library.Folders.Assets}/{Data.Id}`, game:HttpGet(Data.Url))
            end
                ...
                faces = {
                    {
                        ...
                        weight = Weight,
                        style = Style,
                        assetId = getcustomasset(`{Library.Folders.Assets}/{Data.Id}`)
                    }
                }
            }

            writefile(`{Library.Folders.Assets}/{Name}.font`, HttpService:JSONEncode(Data))
            return Font.new(getcustomasset(`{Library.Folders.Assets}/{Name}.font`), Enum.FontWeight.Regular, Enum.FontStyle.Normal)
        end
    ...
    do
        ...
        Library.Window = function(self, Data)
            ...
            local Window = {
                ...
                SubTitle = Data.SubTitle or Data.subtitle or "for Roblox",
        ...
        Library.Sections.Toggle = function(self, Data)
            ...
            function Toggle:Set(Value)
                ...
                Library.Notification(Library, Toggle.Name..' has been '..tog, 2.7, '11422155687')
            end
